...
This table lists the configuration variables required to operate Splunk On-Call. These variables are specified when configuring a Splunk On-Call asset in Splunk SOAR.
